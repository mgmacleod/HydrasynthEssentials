...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 528.0, 341.0, 92.0, 22.0 ],
					"text" : "r ---bypassGate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 506.0, 317.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 251.5, 338.0, 79.0, 22.0 ],
					"text" : "r ---loadBang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 229.5, 314.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 209.5, 290.0, 88.0, 22.0 ],
					"text" : "r ---closeGates"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 385.5, 492.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 216.0, 57.0, 22.0 ],
					"text" : "active $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 250.0, 183.0, 77.0, 22.0 ],
					"text" : "scale 0 1 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.952380952381077, 222.0, 72.0, 22.0 ],
					"text" : "prepend set"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 356.952380952381077, 151.0, 56.5, 22.0 ],
					"text" : "t f b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 383.952380952381077, 401.0, 82.0, 22.0 ],
					"text" : "gatedsignal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 384.0, 455.0, 79.0, 22.0 ],
					"text" : "nrpnout 8325"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 356.952380952381077, 117.0, 72.0, 22.0 ],
					"text" : "nrpnin 8325"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 356.952380952381077, 259.0, 64.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 356.952393000000029, 57.0, 30.0, 30.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 261.0, 374.0, 424.952380952381077, 374.0 ],
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.141176470588235, 0.250980392156863, 0.109803921568627, 1.0 ],
					"destination" : [ "obj-21", 4 ],
					"midpoints" : [ 239.0, 382.0, 435.452380952381077, 382.0 ],
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 219.0, 392.0, 393.452380952381077, 392.0 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-21::obj-5" : [ "live.numbox", "live.numbox", 0 ],
			"obj-234" : [ "LFO1RateHz", "LFO1Rate", 0 ],
			"parameterbanks" : 			{
