...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.5, 356.0, 79.0, 22.0 ],
					"text" : "r ---loadBang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 425.5, 393.0, 92.0, 22.0 ],
					"text" : "r ---bypassGate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.5, 369.0, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 49.5, 332.0, 113.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 29.5, 308.0, 88.0, 22.0 ],
					"text" : "r ---closeGates"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 287.5, 466.0, 82.0, 22.0 ],
					"text" : "gatedsignal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 166.5, 466.0, 82.0, 22.0 ],
					"text" : "gatedsignal"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 176.0, 608.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 287.5, 536.0, 79.0, 22.0 ],
					"text" : "nrpnout 8329"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 166.5, 536.0, 79.0, 22.0 ],
					"text" : "nrpnout 8335"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 134.0, 264.0, 64.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 259.285714285714334, 264.0, 64.0, 48.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 3 ],
					"midpoints" : [ 81.0, 379.0, 84.5, 379.0, 84.5, 424.0, 207.5, 424.0 ],
					"order" : 1,
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.929411764705882, 0.36078431372549, 0.866666666666667, 1.0 ],
					"destination" : [ "obj-6", 3 ],
					"midpoints" : [ 81.0, 379.0, 84.5, 379.0, 84.5, 433.0, 328.5, 433.0 ],
					"order" : 0,
					"source" : [ "obj-33", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 6 ],
					"midpoints" : [ 435.0, 452.0, 239.0, 452.0 ],
					"order" : 1,
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.0, 0.0, 0.0, 1.0 ],
					"destination" : [ "obj-6", 6 ],
					"midpoints" : [ 435.0, 452.0, 360.0, 452.0 ],
					"order" : 0,
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 5 ],
					"midpoints" : [ 413.0, 433.0, 228.5, 433.0 ],
					"order" : 1,
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.501960784313725, 0.36078431372549, 0.262745098039216, 1.0 ],
					"destination" : [ "obj-6", 5 ],
					"midpoints" : [ 413.0, 433.0, 349.5, 433.0 ],
					"order" : 0,
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 4 ],
					"midpoints" : [ 59.0, 379.0, 62.5, 379.0, 62.5, 408.0, 218.0, 408.0 ],
					"order" : 1,
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.192156862745098, 0.282352941176471, 0.098039215686275, 1.0 ],
					"destination" : [ "obj-6", 4 ],
					"midpoints" : [ 59.0, 379.0, 62.5, 379.0, 62.5, 409.0, 339.0, 409.0 ],
					"order" : 0,
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 39.0, 434.0, 81.5, 434.0, 81.5, 441.0, 120.5, 441.0, 120.5, 437.0, 176.0, 437.0 ],
					"order" : 1,
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.945098039215686, 0.913725490196078, 0.407843137254902, 1.0 ],
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 39.0, 437.0, 81.5, 437.0, 81.5, 436.0, 120.5, 436.0, 120.5, 434.0, 297.0, 434.0 ],
					"order" : 0,
					"source" : [ "obj-37", 0 ]
				}
